...
class RewardScreen(private val offer: RewardOffer) : Screen(Text.literal("Daily Reward")) {
    ...
    private val NODE_TEX_SIZE = 57
    private val CONNECTOR_TEX_WIDTH = 24
    private val CONNECTOR_TEX_HEIGHT = 12
    private val MILESTONE_TEX_SIZE = 110
    private val SHADOW_TEX_SIZE = 66
    ...
    private fun renderStreakBar(context: DrawContext, baseY: Int) {
        ...
        for (i in 0 until 8) {
            ...
            context.drawTexture(
                RenderLayer::getGuiTextured, dropShadowTex,
            ...
            if (status == 1) {
                ...
                context.drawTexture(
                    RenderLayer::getGuiTextured, borderPulseTex[frame],
                    drawX, drawY, 0f, 0f,
                    nodeDrawSize, nodeDrawSize,
                    nodeDrawSize, nodeDrawSize
                )
            ...
            context.drawTexture(
                RenderLayer::getGuiTextured, nodeTex,
                drawX, drawY, 0f, 0f,
                nodeDrawSize, nodeDrawSize,
                nodeDrawSize, nodeDrawSize
            )
        ...
        if (showMilestoneGlow && !isMilestoneClaimAnim) {
            ...
            context.matrices.multiply(RotationAxis.POSITIVE_Z.rotationDegrees(rotationAngle))
            context.matrices.translate(-mCenterX.toFloat(), -centerY.toFloat(), 0f)
            context.drawTexture(
                RenderLayer::getGuiTextured, glowTex,
        ...
        context.drawTexture(
            RenderLayer::getGuiTextured, milestoneTex,
